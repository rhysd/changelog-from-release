...
1. Click 'Draft a new release' button in releases page
2. Write up release note for the next release and fill the title
...
6. Create and push a new Git tag
7. Go to the draft release page created at 1. and set the Git tag to the release
8. Publish the release by clicking 'Publish release' button on GitHub
...
If you use [the action](./action/README.md), an API token is automatically generated by GitHub Actions
so you don't need to create a token by yourself.
